...
#motif=file_peak=sys.argv[4]
b_file=open("./new.tsv","w")
a_file=open("./old.tsv","w")
c_file=open("./comm.tsv","w")
...
with open(file_peak,"r") as c:
	for line in c.readlines():
		line=line.strip().split()
		peak[line[0]].append(tuple([line[1],line[2]]))

def get_dic(ff):
	with open(ff,"r") as f:
		dic1={}
		for line in f.readlines():
			if line[0] != "#" and re.search("m6A",line):
